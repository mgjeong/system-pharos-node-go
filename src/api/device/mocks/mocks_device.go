...
// Source: src/api/device/device.go
...
func (m *MockapiInnerCommand) reboot(w http.ResponseWriter, req *http.Request) {
	m.ctrl.Call(m, "reboot", w, req)
}

// reboot indicates an expected call of reboot
func (mr *MockapiInnerCommandMockRecorder) reboot(w, req interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "reboot", reflect.TypeOf((*MockapiInnerCommand)(nil).reboot), w, req)
}

// restore mocks base method
func (m *MockapiInnerCommand) restore(w http.ResponseWriter, req *http.Request) {
	m.ctrl.Call(m, "restore", w, req)
}

// restore indicates an expected call of restore
func (mr *MockapiInnerCommandMockRecorder) restore(w, req interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "restore", reflect.TypeOf((*MockapiInnerCommand)(nil).restore), w, req)
}
