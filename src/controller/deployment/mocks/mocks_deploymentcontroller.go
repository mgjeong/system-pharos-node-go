...
// Source: deploymentcontroller.go
...
func (m *MockCommand) DeployApp(body string) (map[string]interface{}, error) {
	ret := m.ctrl.Call(m, "DeployApp", body)
...
func (mr *MockCommandMockRecorder) DeployApp(body interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeployApp", reflect.TypeOf((*MockCommand)(nil).DeployApp), body)
}
