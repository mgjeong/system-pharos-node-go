...
pkg_list=("api/common" "api/deployment" "api/health" "api/monitoring/resource" "api/configuration" "controller/deployment" "controller/deployment/dockercontroller" "controller/health" "controller/monitoring/resource" "controller/configuration" "controller/shellcommand" "db/mongo/service" "messenger")
